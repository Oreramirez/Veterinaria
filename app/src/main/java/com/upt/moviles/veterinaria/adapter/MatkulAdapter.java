package com.upt.moviles.veterinaria.adapter;
...
import com.upt.moviles.veterinaria.model.SemuamatkulItem;
...
public class MatkulAdapter extends RecyclerView.Adapter<MatkulAdapter.MatkulHolder> {
    ...
    @Override
    public MatkulHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_veterinaria, parent, false);
        return new MatkulHolder(itemView);
    }

    @Override
    public void onBindViewHolder(MatkulHolder holder, int position) {
